<img width="615" height="455" alt="image" src="https://github.com/user-attachments/assets/3ea70f86-f563-480c-b870-cc7101f53434" />

Open Systems Interconnection

Layer 1: Physical layer like wire and physical connection

Layer 2: Data Link Layer protocol enabled for data transfer on same network (ethernet)

Layer 3: Network layer operates as logical addressing and routing network paths between networks

<img width="1228" height="500" alt="image" src="https://github.com/user-attachments/assets/8886eed0-2800-4b94-afb5-66cf0fbcbf97" />

TCP/IP Model is five layers

<img width="1218" height="728" alt="image" src="https://github.com/user-attachments/assets/22896662-4e2d-41c7-b907-c683f2efed53" />

<img width="595" height="238" alt="image" src="https://github.com/user-attachments/assets/211bcea3-9eef-4761-8d43-daca783dcd59" />

<img width="485" height="154" alt="image" src="https://github.com/user-attachments/assets/8abaa6af-2b82-4605-ae65-74c9d28e7cc0" />

<img width="998" height="490" alt="image" src="https://github.com/user-attachments/assets/e9277658-cf68-46ba-ae72-8605123ae2f5" />

TCP needs confirmation when sending packets vs UDP doesn't need a connection

TCP and UDP work in layer 4 which is transport layer (65K ports)

<img width="1039" height="376" alt="image" src="https://github.com/user-attachments/assets/155861b7-4cb2-44f8-8fc1-e58a6b04df6f" />

IP packet encapsulated in a frame

UDP- Datagram data

TCP- Segment data

<img width="613" height="290" alt="image" src="https://github.com/user-attachments/assets/0fe4ec37-8089-4197-8655-e547049cbdcc" />

Telnet connection 7

<img width="572" height="171" alt="image" src="https://github.com/user-attachments/assets/4fd04058-1c5c-4cd0-bfb0-9dc79bcbd832" />

Telnet connection 13

<img width="565" height="396" alt="image" src="https://github.com/user-attachments/assets/1edc03cb-fbbf-460d-9906-8c5fdd71ccc9" />

case sensitive like uppercase, telnet is used to talk to other servers over TCP

<img width="1006" height="656" alt="image" src="https://github.com/user-attachments/assets/f12c9ec8-3345-4c19-839a-1690d864c3b8" />

<img width="834" height="484" alt="image" src="https://github.com/user-attachments/assets/e8ed2a73-8079-496b-a16a-718c25ef61e2" />

<img width="923" height="134" alt="image" src="https://github.com/user-attachments/assets/17b5946d-1ed7-4026-ae89-32e1cc86631f" />

Ethernet and wifi are two major layer two functions

<img width="1238" height="332" alt="image" src="https://github.com/user-attachments/assets/a1163252-4b43-48bb-84ac-8ad2556bc39a" />

ARP allows for addressing from layer three to layer 2 because it deals with MAC addresses

<img width="996" height="550" alt="image" src="https://github.com/user-attachments/assets/1276b98d-514d-4493-8a3f-c4e58902406e" />

<img width="587" height="300" alt="image" src="https://github.com/user-attachments/assets/06162b11-c095-42de-af3a-ea325af6fa3a" />

limiting amount of packetssent in order for firewall not to block path

<img width="1073" height="357" alt="image" src="https://github.com/user-attachments/assets/c2797c18-04d4-449d-bf64-03cd9de2a81c" />

TTL (time-to-live) needs to drop zero for time exceededmessage

<img width="1217" height="311" alt="image" src="https://github.com/user-attachments/assets/2b7cfed8-870e-41f8-9c0f-9544600b79a3" />

<img width="944" height="735" alt="image" src="https://github.com/user-attachments/assets/b762b545-e2b7-4fea-ad20-c8fbc60a6e13" />

Example of NAT above (Network Address Translation)

<img width="1098" height="130" alt="image" src="https://github.com/user-attachments/assets/80359c4f-f25c-45d8-8510-9e5188967404" />

AAAA refers to IPv6 

<img width="1121" height="183" alt="image" src="https://github.com/user-attachments/assets/865151f5-abda-45ba-8f05-abc28b124e5f" />

<img width="523" height="250" alt="image" src="https://github.com/user-attachments/assets/0bc4a8b3-23b0-4d38-8b21-e8cbcb3b2fb0" />

whois command can help find everything about a domain

<img width="786" height="128" alt="image" src="https://github.com/user-attachments/assets/6d25560f-c287-49ef-9a7a-4edada9b2c71" />

<img width="679" height="340" alt="image" src="https://github.com/user-attachments/assets/34c35074-11a1-4c26-9efd-58dcc1928ac7" />

Usage of telnet on port 80 to find hidden flag within file

<img width="825" height="206" alt="image" src="https://github.com/user-attachments/assets/fd3924ae-5d69-423a-a233-9f4cdf2fd78d" />

<img width="942" height="692" alt="image" src="https://github.com/user-attachments/assets/8b9a1edc-435a-4e79-b00b-496a6322644e" />

<img width="632" height="436" alt="image" src="https://github.com/user-attachments/assets/7f68087d-8567-4096-bb73-27014d461414" />

FTP usage above retrieving a file and opening it for a flag

<img width="825" height="198" alt="image" src="https://github.com/user-attachments/assets/36ed716f-b6c0-4358-82a6-cc6f72d819e9" />

<img width="673" height="558" alt="image" src="https://github.com/user-attachments/assets/c2cb63fa-cb45-4d02-ae64-469991a12681" />

"." to indicate message fully entered

<img width="630" height="244" alt="image" src="https://github.com/user-attachments/assets/09e14561-a804-48ee-923d-47e3fa0e300c" />

<img width="650" height="988" alt="image" src="https://github.com/user-attachments/assets/d9554f4d-2545-4154-b651-4f2e2aa490f9" />

<img width="555" height="371" alt="image" src="https://github.com/user-attachments/assets/d1210466-1664-4857-906b-dc5d4bbb9a6d" />

server is up top (Dovecot), must enter user and pass first before looking for stat and list

<img width="923" height="224" alt="image" src="https://github.com/user-attachments/assets/974c956a-8a01-47bd-a456-43b9d5b24af0" />

<img width="1114" height="928" alt="image" src="https://github.com/user-attachments/assets/6443601e-09d7-4f6b-b20f-bb4751b70edf" />

using fetch # data item name[]
...
PCI DSS is standard for using credit card information

<img width="1221" height="634" alt="image" src="https://github.com/user-attachments/assets/70ad7b57-a242-4563-818b-dd1b35318595" />

<img width="1103" height="605" alt="image" src="https://github.com/user-attachments/assets/209819cd-9024-45d5-a2da-b5d988c62fa8" />

<img width="2153" height="367" alt="image" src="https://github.com/user-attachments/assets/f61c1831-5dd1-4943-823d-a10d07ab2191" />

<img width="2197" height="1076" alt="image" src="https://github.com/user-attachments/assets/75f1e4e8-3d97-4ac8-8fce-25b528a83c9a" />

Caesar Cipher above

<img width="1463" height="863" alt="image" src="https://github.com/user-attachments/assets/ca15c93e-d8c7-4359-9952-4439e2c6f383" />

Symmetric encryption above

<img width="1495" height="811" alt="image" src="https://github.com/user-attachments/assets/0fa337d5-6ca9-4b71-9f37-a530f3a0638e" />

Assymetric encryption above

AES (Advanced Encryption Standard) is the best standard for encryption established 2001

<img width="2208" height="782" alt="image" src="https://github.com/user-attachments/assets/27986e9e-e7be-4a9b-8cd2-39fe5e4426be" />

XOR is commutative and associative 

<img width="2232" height="593" alt="image" src="https://github.com/user-attachments/assets/7b6e0c6f-a891-454c-af35-70bc4a717ee8" />

<img width="874" height="431" alt="image" src="https://github.com/user-attachments/assets/959db20f-b8a1-43d0-a0d0-a1771a775ae2" />

<img width="1257" height="461" alt="image" src="https://github.com/user-attachments/assets/d0c76aff-2e9a-44b2-977e-76d0e7ca9522" />

<img width="1144" height="408" alt="image" src="https://github.com/user-attachments/assets/55d16d76-0413-4076-81e6-c683c8be587c" />

<img width="823" height="630" alt="image" src="https://github.com/user-attachments/assets/ca49bd44-f748-4d79-80a6-4ab03b123f8b" />

diffie-hellman

<img width="1239" height="453" alt="image" src="https://github.com/user-attachments/assets/64ab4c69-0715-4537-a279-96fe275d529a" />

<img width="1208" height="456" alt="image" src="https://github.com/user-attachments/assets/35935685-577e-4f81-ac44-f88192783d20" />

<img width="1230" height="487" alt="image" src="https://github.com/user-attachments/assets/6f7f6ada-d69c-4962-b040-468b0c3ca8ce" />

<img width="1249" height="1015" alt="image" src="https://github.com/user-attachments/assets/debb4e3b-c3ce-45d6-ba0e-e37bebf145b7" />

Encryption of hashes above not messages 

<img width="1223" height="825" alt="image" src="https://github.com/user-attachments/assets/8ce1816b-638c-462b-842f-7ec00719cb6a" />

<img width="1159" height="1174" alt="image" src="https://github.com/user-attachments/assets/efc37b3e-be82-4549-9cad-49f2b7e121ce" />
